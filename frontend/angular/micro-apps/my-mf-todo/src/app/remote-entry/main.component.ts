...
@Component({
  selector: 'app-main',
  imports: [ReactiveFormsModule, DeliveryComponent, FormsModule, JsonPipe, MatTabsModule, TwoWayDataBindingComponent, CustomTwoWayDataBindingUsingOwnBindingComponent, DeliveryWithInputComponent],
