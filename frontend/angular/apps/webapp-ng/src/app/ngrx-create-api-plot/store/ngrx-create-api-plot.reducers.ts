...
import { LOADED_ACTION_ALIAS_TYPING, LoadedLayoutDataAction, LoadedPlotDataAction, SelectedPlotDataAction, UPDATED_ACTION_ALIAS_TYPING, UpdatePlotDataAction } from './ngrx-create-api-plot.actions';
...
export const plotRedurcer = createReducer<PlotModel, LOADED_ACTION_ALIAS_TYPING>(initialPlotModel,
    ...
    on(UpdatePlotDataAction, (state: PlotModel, action: UPDATED_ACTION_ALIAS_TYPING) => ({ ...state, ...action.plotModel })),
