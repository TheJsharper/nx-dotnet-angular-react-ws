(self["webpackChunkmy_mf_todo"] = self["webpackChunkmy_mf_todo"] || []).push([["default-node_modules_angular_router_fesm2022_router_mjs"],{
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs */ 2551);
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! rxjs */ 3335);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! rxjs */ 4665);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! rxjs */ 137);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! rxjs */ 5682);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! rxjs */ 7919);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! rxjs */ 9400);
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! rxjs/operators */ 3255);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! rxjs/operators */ 2435);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! rxjs/operators */ 1903);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! rxjs/operators */ 8764);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! rxjs/operators */ 1318);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! rxjs/operators */ 2112);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! rxjs/operators */ 778);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! rxjs/operators */ 2157);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! rxjs/operators */ 602);
...
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/platform-browser */ 2348);
/**
...
function wrapIntoObservable(value) {
  if ((0,rxjs__WEBPACK_IMPORTED_MODULE_3__.isObservable)(value)) {
    return value;
  }
...
class ActivatedRoute {
  ...
  component, futureSnapshot) {
    ...
    this.title = this.dataSubject?.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.map)(d => d[RouteTitleKey])) ?? (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.of)(undefined);
   ...
   */
  get paramMap() {
    this._paramMap ??= this.params.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.map)(p => convertToParamMap(p)));
   ...
   */
  get queryParamMap() {
    this._queryParamMap ??= this.queryParams.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.map)(p => convertToParamMap(p)));
    return this._queryParamMap;
  }
  toString() {
...
function isEmptyError(e) {
  return e instanceof rxjs__WEBPACK_IMPORTED_MODULE_10__.EmptyError || e?.name === 'EmptyError';
}
...
function checkGuards(injector, forwardEvent) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.mergeMap)(t => {
    ...
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.map)(guardsResult => ({
      ...t,
      guardsResult
    })));
  });
...
function namedOutletsRedirect(redirectTo) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_21__.throwError)(new _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵRuntimeError"](4000 /* RuntimeErrorCode.NAMED_OUTLET_REDIRECT */, (typeof ngDevMode === 'undefined' || ngDevMode) && `Only absolute redirects can have named outlets. redirectTo: '${redirectTo}'`));
}
...
function matchWithChecks(segmentGroup, route, segments, injector, urlSerializer) {
  ...
  return runCanMatchGuards(injector, route, segments, urlSerializer).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.map)(v => v === true ? result : {
    ...noMatch
  }));
}
...
class Recognizer {
  ...
  processSegment(injector, routes, segmentGroup, segments, outlet, allowRedirects, parentRoute) {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.from)(routes).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.concatMap)(r => {
      return this.processSegmentAgainstRoute(r._injector ?? injector, routes, r, segmentGroup, segments, outlet, allowRedirects, parentRoute).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_22__.catchError)(e => {
        if (e instanceof NoMatch) {
...
class DefaultTitleStrategy extends TitleStrategy {
  ...
  static ɵfac = function DefaultTitleStrategy_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || DefaultTitleStrategy)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__.Title));
  };
  static ɵprov = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
...
class NavigationTransitions {
   ...
   * @internal
   */
  afterPreactivation = () => (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.of)(void 0);
  /** @internal */
  ...
  setupNavigations(router, initialUrlTree, initialRouterState) {
    this.transitions = new rxjs__WEBPACK_IMPORTED_MODULE_6__.BehaviorSubject({
      id: 0,
    ...
    return this.transitions.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.filter)(t => t.id !== 0),
    // Extract URL
    ...
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.switchMap)(overallTransitionState => {
      ...
      // transition.
      (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_32__.takeUntil)(this.transitionAbortSubject.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_20__.tap)(err => {
        throw err;
      }))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_28__.finalize)(() => {
...
class RouterLinkActive {
  ...
  ngAfterContentInit() {
    ...
    (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.of)(this.links.changes, (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.of)(null)).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_34__.mergeAll)()).subscribe(_ => {
      this.update();
  ...
  subscribeToEachLinkOnChanges() {
    ...
    this.linkInputChangesSubscription = (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.from)(allLinkChanges).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_34__.mergeAll)()).subscribe(link => {
...
class PreloadAllModules {
  preload(route, fn) {
    return fn().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_22__.catchError)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.of)(null)));
  }
...
class RouterPreloader {
  ...
  setUpPreloading() {
    this.subscription = this.router.events.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.filter)(e => e instanceof NavigationEnd), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.concatMap)(() => this.preload())).subscribe(() => {});
  }
  preload() {
  ...
  processRoutes(injector, routes) {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.from)(res).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_34__.mergeAll)());
  }
  preloadConfig(injector, route) {
    return this.preloadingStrategy.preload(route, () => {
      ...
      if (route.loadChildren && route.canLoad === undefined) {
        ...
        loadedChildren$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.of)(null);
      }
      const recursiveLoadChildren$ = loadedChildren$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.mergeMap)(config => {
        if (config === null) {
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.of)(void 0);
        }
      ...
      if (route.loadComponent && !route._loadedComponent) {
        ...
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.from)([recursiveLoadChildren$, loadComponent$]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_34__.mergeAll)());
      } else {
        ...
        return locationInitialized.then(() => {
          return new Promise(resolve => {
            ...
            injector.get(NavigationTransitions).afterPreactivation = () => {
              ...
              // guaranteed).
              resolve(true);
              return bootstrapDone.closed ? (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.of)(void 0) : bootstrapDone;
            };
            router.initialNavigation();
          });
        });
