(self["webpackChunkmf_todo"] = self["webpackChunkmf_todo"] || []).push([["default-node_modules_ngrx_store-devtools_fesm2022_ngrx-store-devtools_mjs"],{
...
/* harmony import */ var _angular_core_rxjs_interop__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/core/rxjs-interop */ 3927);
...
class DevtoolsExtension {
  ...
  createActionStreams() {
    ...
    const changes$ = this.createChangesObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.share)());
    // Listen for the start action
    const start$ = changes$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(change => change.type === ExtensionActionTypes.START));
    // Listen for the stop action
    const stop$ = changes$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(change => change.type === ExtensionActionTypes.STOP));
    // Listen for lifted actions
    const liftedActions$ = changes$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(change => change.type === ExtensionActionTypes.DISPATCH), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(change => this.unwrapAction(change.payload)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.concatMap)(action => {
      if (action.type === IMPORT_STATE) {
        ...
        return this.dispatcher.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(action => action.type === _ngrx_store__WEBPACK_IMPORTED_MODULE_1__.UPDATE), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.timeout)(1000), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.debounceTime)(1000), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(() => action), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.catchError)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(action)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.take)(1));
      } else {
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(action);
      }
    }));
    // Listen for unlifted actions
    const actions$ = changes$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(change => change.type === ExtensionActionTypes.ACTION), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(change => this.unwrapAction(change.payload)));
    const actionsUntilStop$ = actions$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(stop$));
    const liftedUntilStop$ = liftedActions$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(stop$));
    this.start$ = start$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeUntil)(stop$));
    // Only take the action sources between the start/stop events
    this.actions$ = this.start$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(() => actionsUntilStop$));
    this.liftedActions$ = this.start$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(() => liftedUntilStop$));
  }
  unwrapAction(action) {
...
class StoreDevtools {
  constructor(dispatcher, actions$, reducers$, extension, scannedActions, errorHandler, initialState, config) {
    ...
    const liftedAction$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.merge)((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.merge)(actions$.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.skip)(1)), extension.actions$).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(liftAction)), dispatcher, extension.liftedActions$).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.observeOn)(rxjs__WEBPACK_IMPORTED_MODULE_2__.queueScheduler));
    const liftedReducer$ = reducers$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(liftReducer));
    ...
    this.liftedStateSubscription = liftedAction$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.withLatestFrom)(liftedReducer$),
    ...
    emitInZone(zoneConfig), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.scan)(({
      state: liftedState
    }, [action, reducer]) => {
    ...
    const state$ = liftedState$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(unliftState));
    Object.defineProperty(state$, 'state', {
      value: (0,_angular_core_rxjs_interop__WEBPACK_IMPORTED_MODULE_4__.toSignal)(state$, {
        manualCleanup: true,
        requireSync: true
      })
    });
...
function emitInZone({
  ...
  return source => connectInZone ? new rxjs__WEBPACK_IMPORTED_MODULE_2__.Observable(subscriber => source.subscribe({
...
//# sourceMappingURL=default-node_modules_ngrx_store-devtools_fesm2022_ngrx-store-devtools_mjs.js.map