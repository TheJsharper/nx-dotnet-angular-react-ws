(self["webpackChunkmf_todo"] = self["webpackChunkmf_todo"] || []).push([["default-node_modules_angular_router_fesm2022_router_mjs"],{
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ 8807);
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/platform-browser */ 2348);
/**
...
class Recognizer {
  ...
  recognize() {
    ...
    return this.match(rootSegmentGroup).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(({
      children,
      rootSnapshot
    }) => {
  ...
  match(rootSegmentGroup) {
    ...
    return this.processSegmentGroup(this.injector, this.config, rootSegmentGroup, PRIMARY_OUTLET, rootSnapshot).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(children => {
      return {
        children,
        rootSnapshot
      };
  ...
  processSegmentGroup(injector, config, segmentGroup, outlet, parentRoute) {
    ...
    return this.processSegment(injector, config, segmentGroup, segmentGroup.segments, outlet, true, parentRoute).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(child => child instanceof TreeNode ? [child] : []));
  }
  /**
  ...
  processSegment(injector, routes, segmentGroup, segments, outlet, allowRedirects, parentRoute) {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(routes).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.concatMap)(r => {
      return this.processSegmentAgainstRoute(r._injector ?? injector, routes, r, segmentGroup, segments, outlet, allowRedirects, parentRoute).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.catchError)(e => {
        if (e instanceof NoMatch) {
    ...
    return matchResult.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(result => {
      ...
      return this.getChildConfig(injector, route, segments).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(({
        ...
        if (slicedSegments.length === 0 && segmentGroup.hasChildren()) {
          return this.processChildren(childInjector, childConfig, segmentGroup, snapshot).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(children => {
        ...
        return this.processSegment(childInjector, childConfig, segmentGroup, slicedSegments, matchedOnOutlet ? PRIMARY_OUTLET : outlet, true, snapshot).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(child => {
...
function resolveNode(resolve, futureARS, futureRSS, injector) {
  ...
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(keys).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(key => getResolver(resolve[key], futureARS, futureRSS, injector).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.first)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)(value => {
    ...
    data[key] = value;
  }))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeLast)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(() => data), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.catchError)(e => isEmptyError(e) ? rxjs__WEBPACK_IMPORTED_MODULE_1__.EMPTY : (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.throwError)(e)));
}
...
class DefaultTitleStrategy extends TitleStrategy {
  ...
  static ɵfac = function DefaultTitleStrategy_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || DefaultTitleStrategy)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__.Title));
  };
  static ɵprov = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
...
class NavigationTransitions {
   ...
   */
  events = new rxjs__WEBPACK_IMPORTED_MODULE_1__.Subject();
  /**
   * Used to abort the current transition with an error.
   */
  transitionAbortSubject = new rxjs__WEBPACK_IMPORTED_MODULE_1__.Subject();
  ...
  location = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_angular_common__WEBPACK_IMPORTED_MODULE_2__.Location);
   ...
   * @internal
   */
  afterPreactivation = () => (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(void 0);
  /** @internal */
  ...
  setupNavigations(router, initialUrlTree, initialRouterState) {
    ...
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(overallTransitionState => {
      let completed = false;
      let errored = false;
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(overallTransitionState).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(t => {
...
function afterNextNavigation(router, action) {
  ...
  }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(result => result !== 2 /* NavigationResult.REDIRECTING */), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.take)(1)).subscribe(() => {
    action();
  });
}
...
class Router {
  ...
  eventsSubscription = new rxjs__WEBPACK_IMPORTED_MODULE_1__.Subscription();
...
class RouterLink {
  ...
  subscription;
  /** @internal */
  onChanges = new rxjs__WEBPACK_IMPORTED_MODULE_1__.Subject();
